...
cv::Mat Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const cv::Mat &objmap, const double &timestamp)
{
    mImGray = imRGB;
    cv::Mat imDepth = imD;
    ...
    mCurrentFrame = Frame(mImGray,imDepth,objmap,timestamp,mpORBextractorLeft,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth);
...
//            std::cout << "nmatches: " << nmatches << std::endl;
            ...
            {
                vbDiscarded[i] = true;
//                std::cout << "------------------------- nmatches failed!" << std::endl;
                continue;
            }
            else
            {
    ...
    bool bMatch = false;
    ORBmatcher matcher2(0.97,true);
//    std::cout << "nCandiates: " << nCandidates << std::endl;
...
//                std::cout << "nGood 1: " << nGood << std::endl;
...
//                        std::cout << "nGood 2: " << nGood << std::endl;
                        ...
                        if(nGood>20 && nGood<30)
                        {
                            ...
                            {
                                nGood = Optimizer::PoseOptimization(&mCurrentFrame);
//                                std::cout << "nGood 3: " << nGood << std::endl;
...
//                    std::cout << "------------------------- nGood failed!" << std::endl;
                }
            } else {
